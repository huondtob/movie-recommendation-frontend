...
export default function (state = INITIAL_STATE, action) {
  switch (action.type) {
    case LOGIN_USER:
      return {
        ...state, authenticated: false, error: null, loading: true,
      };

    case LOGIN_USER_SUCCESS:
      return {
        ...state, authenticated: true, error: null, loading: false,
      };

    case LOGIN_USER_FAILURE:
      return {
        ...state, authenticated: false, error: action.error, loading: false,
      };
    ...
    case LOGOUT_USER_SUCCESS:
      return {
        ...state, authenticated: false, error: null, loading: false,
      };
